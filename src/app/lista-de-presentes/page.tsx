...
export const metadata: Metadata = {
  ...
  description:
    'Acesse as listas de presentes do casal Andressa e Eduardo em nossas lojas parceiras: Magazine Luiza e Havan.',
...
const giftRegistries = [
  {
    ...
    logoUrl: '/images/logo-magalu-azul.png',
    description: 'Encontre presentes para casa, eletrodomesticos e muito mais',
  },
  {
    storeName: 'Havan',
    storeUrl: 'https://lista.havan.com.br/Convidado/ItensListaPresente/908346',
    logoUrl: '/images/logo-havan.png',
    description: 'Variedade de produtos para o lar e decoracao',
  },
];
    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <header className="text-center mb-8 sm:mb-12">
        ...
        <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">
          Sua presenca e o nosso maior presente! Mas se desejar nos presentear, escolha
          algo especial em nossas lojas parceiras.
        </p>
      </header>
